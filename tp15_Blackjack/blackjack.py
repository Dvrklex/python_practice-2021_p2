...
class Player(Dealer):
    ...
    def hit_or_stick():
        while True:
            choice = input("Quieres otra carta? (S/N)? ")
...
def main():
    ...
    player_name = input("Bienvenido al casino!  Ingresa tu nombre ")
    Table(player_name)
